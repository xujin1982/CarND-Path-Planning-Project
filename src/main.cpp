      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            bool too_much_close = false;
            bool safe_turn_left = false;
            bool safe_turn_right = false;
            double vx, vy, check_speed, check_car_s, dis_car_s_front, dist;
            double vx_left, vy_left, check_speed_left, dis_car_s_left_front, dis_car_s_left_behind;
            ...
            dis_car_s_right_front = 100;
            dis_car_s_right_behind = 100;

            // initial the speed with 0 m/s
            check_speed_left = 0;
            check_speed_right = 0;
            ...
            for(int i = 0; i < sensor_fusion.size(); i++){
                ...
                float lane_left = 2 + 4 * lane - 2;
                float lane_right = 2 + 4 * lane + 2;
                ...
                if(d < lane_right && d > lane_left){
                    ...
                    if(check_car_s > car_s){
                        ...
                        if(dist < dis_car_s_front){
                            dis_car_s_front = dist;
                        }
                    }
                    /*
                       && ){
                    ...
                    */
                ...
                else if(lane > 0 && d < lane_left && d > (lane_left - 4) && turn_steps <= 0){
                    vx_left = sensor_fusion[i][3];
                    vy_left = sensor_fusion[i][4];
                    check_speed = sqrt((vx_left * vx_left) + (vy_left * vy_left)) * 2.24;
                    ...
                    if(check_car_s > car_s){
                        if(dist < dis_car_s_left_front){
                            dis_car_s_left_front  = dist;
                        }
                    }
                    else{
                        if(dist < dis_car_s_left_behind){
                            dis_car_s_left_behind = dist;

                        }
                    }
                }
                else if(lane < 2 && d > lane_right && d < (lane_right + 4) && turn_steps <= 0){
                    vx_right = sensor_fusion[i][3];
                    vy_right = sensor_fusion[i][4];
                    check_speed = sqrt((vx_right * vx_right) + (vy_right * vy_right)) * 2.24;
                    ...
                    if(check_car_s > car_s){
                        if(dist < dis_car_s_right_front){
                            dis_car_s_right_front  = dist;
                        }
                    }
                    else{
                        if(dist < dis_car_s_right_behind){
                            dis_car_s_right_behind = dist;
...
/*
            ...
            cout<< dis_car_s_left_front << endl;
            cout<< dis_car_s_left_behind << endl;
            cout<< check_speed_left << endl;

            cout<< dis_car_s_right_front << endl;
            cout<< dis_car_s_right_behind << endl;
...
*/
            ...
            // Create a list of widely spaced (x,y) waypoints, evenly spaced at 30,
            ...
            s.set_points(ptsx, ptsy);
          	...
          	for(int i = 1; i <= 50 - previous_path_x.size(); i++){
                double N = (target_dist / (0.02 * ref_vel / 2.24)); // 2.24 miles per hour = 1 meters per second
